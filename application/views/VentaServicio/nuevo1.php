        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <h4>Seleccion del Paquete</h4>
                        <div class="form-group">
                            <select name="membresia" id="membresia" class="form-control">
                                <option value="">Seleccione Membresía</option>
                                <?php foreach ($data["membresias"] as $membresia): ?>
                                    <option value="<?php echo $membresia["tipo_membresia_id"];?>"><?php echo $membresia["tipo_membresia_descripcion"];?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
...
<script type="text/javascript">
    ...
    $("#categoria").on("change", function(){
        id = $(this).val(); 
        $.ajax({
            url: base_url + "VentaServicio/BuscarProductosCategoria",
            type: "POST", 
            data:{idcategoria:id},
            dataType:"json",

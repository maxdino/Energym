                    ...
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select multiple id="select2_example" id="idCliente" name="idCliente[]" class="form-control" required> 
                        ...
                        <div class="form-group">                    
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="<?php echo base_url();?>VentaServicio" class="btn btn-danger">Volver</a>
                                </div>
                           
                        </div>
                    </div>
                    <div class="col-md-4">
                        <h4>Seleccion Categoría Membresía</h4>
                        <div class="form-group">
  ...
  var minimum = 1;
    ...
    $(document).on("click", ".btn-selected", function(){
        ...
        if (verificar(infoBtn[0])) {
            ...
            html += '<td><input type="date" class="form-control" autocomplete="off" value="'+date+'" required="true"  name="fecha_inicio" id="fecha_inicio"></td>';
            html += '<td><input type="hidden" name="precios" class="form-control" value="'+infoBtn[3]+'">'+infoBtn[3]+'</td>';
            html += "<td>";
            html +='<input type="number" name="cantidades" min="1" class="form-control input-cantidad" value="1">';
            html += "</td>";
            html += "<td>";
            ...
            $('#select2_example').select2({
              maximumSelectionLength: infoBtn[5]
            });
    ...
    $("#membresia").on("change", function(){
        id = $(this).val(); 
        $.ajax({
            url: base_url + "VentaServicio/BuscarCategoriaMembresia",
            type: "POST", 
            data:{idcategoria:id},
            dataType:"json",
...
function generar_venta(){
   vminimum = minimum;
  if($("#select2_example").select2('data').length>=vminimum){ 
  } else {
    alert('Debe seleccionar los '+ vminimum +' Clientes')
         return false;
  }
...
$.post(base_url+"VentaServicio/procesar_venta",JSON.stringify(datos_matriz),function(data){ 
         ...
         $("#modal_pagar_venta").modal("hide"); 
          Swal.fire({
            ...
            if (result.value) {
              var url=base_url+"VentaServicio/mostrar_comprobante/"+data;
            ...
            location.href = base_url+"VentaServicio";
          });

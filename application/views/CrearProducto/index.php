                         ...
                         <table class="table display product-overview mb-30" id="myTable">
                          ...
                          <tbody id="cuerpo_tabla">
                           <?php $c=1; foreach ($data["tabla"] as $key => $value) {
                            ...
                            echo '<td><a  onclick="eliminar('.$a.')" class="text-inverse" title="Eliminar" data-toggle="tooltip"><i class="mdi mdi-delete-empty txt-danger"></i></a> <a href="'.base_url().'R_producto/editar/'.$value["producto_id"].'" class="text-inverse" title="Editar" data-toggle="tooltip"><i class="mdi mdi-table-edit txt-danger"></i></a></td>';
                            echo "</tr>";
                            $c++;
                          }  ?>
                        </tbody>
  ...
  function eliminar(id)
{
  ...
  if (result.value) {
    $.post(base_url+"R_producto/eliminar",{"id":id},function(data){
          location.reload();
    });
  }
});

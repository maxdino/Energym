						...
						<div class="panel-body">
							<div class="form-wrap">
								<form method="POST" action="<?php echo base_url();?>almacen/guardar">
									...
									<div class="form-group"> 
										<label class="control-label mb-10 text-left">DIRECCIÓN DE ALMACEN</label>
										<input type="text" class="form-control" required="true" name="direccion" id="direccion" autofocus="true" value="">
									</div>	
									<br>
									<center><a href="<?php echo  base_url();?>almacen"><button class="btn btn-primary">Guardar</button></a><a href="<?php echo  base_url();?>almacen"><button class="btn btn-danger" type="button" >Cancelar</button></a></center>								
								</form>
							</div>
						</div>
					</div>
